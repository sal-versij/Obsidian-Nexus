...
- $\text{Peso }\delta_j \forall \text{ Componente } x_j$
- Moltiplicazione dei pesi per le componenti di input
- Somma dei prodotti
- Risultato delle somme è confrontato rispetto a t risultando $1$ quando $\sum_{j=1}^{d}{\delta_jx_j}>t$ altrimenti $0$
...
- correzione dei pesi e del biass
